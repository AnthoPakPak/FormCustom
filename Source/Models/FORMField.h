...
@property (nonatomic) NSString *titleCustom; //ANTHO : champ qui n'est pas affiché dans le form, mais s'il est rempli on l'utilise lors de l'affiche du popup de validation
