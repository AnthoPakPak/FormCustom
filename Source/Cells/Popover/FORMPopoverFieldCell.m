...
- (instancetype)initWithFrame:(CGRect)frame contentViewController:(UIViewController *)contentViewController
    ...
    if (!isDropdown) {
        ...
        [self.contentView addSubview:self.fieldValueTextField];
    }
...
- (FORMTextField *)fieldValueTextField {
    if (_fieldValueTextField) return _fieldValueTextField;
    
    _fieldValueTextField = [[FORMTextField alloc] initWithFrame:[self fieldValueTextFieldFrame]];
    
    return _fieldValueTextField;
}
...
- (CGRect)fieldValueTextFieldFrame {
    CGFloat marginX = FORMTextFieldCellMarginX;
    CGFloat marginTop = FORMFieldCellMarginTop;
    CGFloat marginBotton = FORMFieldCellMarginBottom;
