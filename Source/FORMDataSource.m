...
//    _originalInset = collectionView.contentInset;
    _originalInset = UIEdgeInsetsMake(20.0f, 0.0f, 0.0f, 0.0f); //obligé de mettre en dur car sinon collectionView.contentInset est nul à cet endroit…
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView
    ...
    switch (field.type) {
        ...
        case FORMFieldTypeDropdown:
            identifier = [NSString stringWithFormat:@"%@-%@", FORMDropdownFormFieldCellIdentifier, field.fieldID];
            [collectionView registerClass:[FORMDropdownFieldCell class]
               forCellWithReuseIdentifier:identifier];
            break;
...
- (void)insertItemsAtIndexPaths:(NSArray *)indexPaths {
    ...
    if (reloadedIndexPaths.count > 0) {
        [self.collectionView performBatchUpdates:^{
            ...
            if (finished) {
                //ANTHO
                NSLog(@"ANTHO REMOVED RELOADDATA / MAY PRODUCE BUG");
...
//        }];
        ...
        //from https://github.com/hyperoslo/Form/pull/561
